...
public class HiddenMidBossStatus : MonoBehaviour
{
    //히든맵 중보스프리팹에 달 것
    //보스 체력
    ...
    float time;
    public HiddenStage hiddenStage;
    ...
    private void OnEnable()
    {
        ...
        hiddenStage = GameObject.Find("MainCamera").GetComponent<HiddenStage>();
    ...
    private void Update()
    {
        ...
        if (boss_hp <= 0)
        {
            ...
            Player_status.PS_score += 40000;
            hiddenStage.phase++;
            hiddenStage.stageHiddenTimecheck = 0;
            Destroy(gameObject);
        }
    }
    //탄, 폭탄 피격시
